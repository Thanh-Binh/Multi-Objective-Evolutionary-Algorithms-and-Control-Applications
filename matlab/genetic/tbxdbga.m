...
%
% This function implements the distributed breeder genetic
% algorithm (by Muehlenbein et.al.).
%
% Syntax:  [xnew, GOPTIONS] = tbxdbga(FUN, GOPTIONS, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)
%
% Input parameter:
...
%
% See also: genalg1, scrgtx01, tbxmpga, tbxdbin, tbxloga

% Author:     Hartmut Pohlheim
% History:    21.03.95     file created (copy of tbxmpga.m)

function [xnew, GOPTIONS] = tbxdbga(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10);
...
% Set function specific parameters
   ...
   GOPTIONS_SET(23) = 2;       % Selection pressure
   GOPTIONS_SET(26) = 0.2;     % Migration rate
   GOPTIONS_SET(27) = 1;       % Migration structure
