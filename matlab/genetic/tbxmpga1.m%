...
%
% Syntax:  [xnew, GOPTIONS] = tbxmpga(FUN, GOPTIONS, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)
%
% Input parameter:
...
function [xnew, GOPTIONS] = tbxmpga(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10);
