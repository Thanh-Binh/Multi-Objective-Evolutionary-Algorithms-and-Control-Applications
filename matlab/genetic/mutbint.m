% MUTation for BINary and INTeger representation
%
...
% population. The population can be in binary or integer representation.
%
% Syntax:  NewChrom = mutbint(OldChrom, Pm, BaseV)
%
% Input parameters:
...
function NewChrom = mutbint(OldChrom, Pm, BaseV)
