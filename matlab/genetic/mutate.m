...
%    FieldDR   - Matrix describing the boundaries of each variable (real values) or
%                defining the base of the variables of each individual (discret values).
...
%                           for instance actual generation (only for real values).
...
%
% See also: mutbga, mutbint, migrate, recombin, select
