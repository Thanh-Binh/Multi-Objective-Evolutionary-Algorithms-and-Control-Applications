...
%
% Syntax:  [xnew, GOPTIONS] = tbxmpga1(FUN, GOPTIONS, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)
%
% Input parameter:
...
%
% See also: genalg1, scrgtx01, tbxdbga, tbxdbin, tbxloga
...
function [xnew, GOPTIONS] = tbxmpga1(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10);
...
% Set function specific parameters
   ...
   GOPTIONS_SET(5)  = 0;       % Selection algorithm
...
% Build string for calling genetic algorithm
   genevalstr = ['genalg2(FUN, GOPTIONS, VLB, VUB'];
   if ~any(FUN < 48)
      for i = 1:nargin-4
