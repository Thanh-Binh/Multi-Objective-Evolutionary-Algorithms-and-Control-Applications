function [acl,bcl,ccl,dcl,f,ccl2,dcl2,Ae,Be,Ce,De] = lqgcfg11(x,a,b,c,d,ricmethod)
%  [acl,bcl,ccl,dcl,f,ccl2,dcl2,Ae,Be,Ce,De] = lqgcfg11(x,a,b,c,d,ricmethod)
%
...
if nargin <5,
  error('usage: [acl,bcl,ccl,dcl,ccl2,dcl2,f,Ae,Be,Ce,De] = lqgcfg11(x,a,b,c,d,ricmethod)')
elseif nargin <6,
  ricmethod = 2;
end
...
Hh=inv(eye(r)+d*De);
acl=[a-b*De*Hh*c, b*Ce - b*De*Hh*d*Ce; -Be*Hh*c   Ae-Be*Hh*d*Ce];
bcl=[b*De*Hh; Be*Hh];
ccl=[c-d*De*Hh*c, d*Ce-d*De*Hh*d*Ce];
dcl=d*De*Hh;
if nargout >5,
   ccl2=[-De*Hh*c  (Ce-De*Hh*d*Ce)];
   dcl2=De*Hh;
else,
   ccl2=[];dcl2=[];
end
